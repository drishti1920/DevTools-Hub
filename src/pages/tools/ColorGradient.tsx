...
export default function ColorGradient() {
  ...
  const addColorStop = () => {
    ...
    setColorStops([...colorStops, { id: newId, color: newColor, position: newPosition }]);
  };
  ...
  const downloadSVG = () => {
    const svgContent = `
      <svg xmlns="http://www.w3.org/2000/svg" width="800" height="600">
        <defs>
          <${gradientType}Gradient id="grad1" ${gradientType === "linear" ? 'x1="0%" y1="0%" x2="100%" y2="0%"' : 'cx="50%" cy="50%" r="50%"'}>
